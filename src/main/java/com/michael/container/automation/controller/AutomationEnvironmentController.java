...
public class AutomationEnvironmentController {
    ...
    public AutomationEnvironmentController(RegisterNotificationService registerNotificationService,
                                           HealthCheckRoutine healthCheckRoutine) {
        this.registerNotificationService = (RegisterNotificationService) translateToRealObject(registerNotificationService);
